...
export const userPortal: UserPortalNS = {
  components: {
    ...
    federatedAssociations: {
      deleteConfirmation: "Isso removerá esse login externo da sua conta. Deseja continuar removendo?" + "removing?",
      notifications: {
    ...
    linkedAccounts: {
      ...
      deleteConfirmation: "Isso removerá a conta vinculada da sua conta. Deseja continuar removendo?" + "removing?",
      forms: {
        addAccountForm: {
          inputs: {
            password: {
    ...
    mfa: {
      authenticatorApp: {
        description: "Digitalize o código QR usando um aplicativo Authenticator para usar o  TOTP como um segundo fator de autenticação" + " as a second " + "authentication factor",
      ...
      fido: {
        ...
        modals: {
          deviceRegistrationErrorModal: {
            description: "O registro do dispositivo foi interrompido. Se isso não foi intencional, tente " + "novamente o mesmo fluxo ou tente novamente com uma chave de segurança mais antiga.",
        ...
        notifications: {
          ...
          startFidoFlow: {
            ...
            success: {
              description: "O dispositivo foi registrado com sucesso e agora você pode usá-lo como" + " um fator de autenticação",
    ...
    privacy: {
      ...
      privacyPolicy: {
        ...
        description: {
          ...
          para2: "Observe que esta política é apenas para referência e é aplicável ao software como um " + "roduto. A WSO2 Inc. e seus desenvolvedores não têm acesso às informações mantidas no " + "WSO2 IS. Consulte a seção <1> isenção de responsabilidade </1> para obter mais informações.",
        ...
        useOfPersonalInfo: {
          description: {
            list1: {
              ...
              2: "Derivar dados estatísticos para fins analíticos nas melhorias de desempenho do " + "WSO2 IS will not keep any personal information after statistical calculations. " + "estatísticos. Portanto, o relatório estatístico não tem como identificar  uma pessoa individualmente."
            },
        ...
        whatIsPersonalInfo: {
          description: {
            list1: {
              0: "Seu nome de usuário (exceto nos casos em que o nome de usuário criado por seu  empregador esteja sob contrato)" + "under contract)",
            ...
            para2: "No entanto, o WSO2 IS também coleta as seguintes informações que não são " + "consideradas informações pessoais, mas são usadas apenas para fins  <1> estatísticos </1>. A razão para isso é que essas informações não podem ser usadas " + "for this is that this information can not be used to track you."
          },
  ...
  modals: {
    editAvatarModal: {
      content: {
        gravatar: {
          errors: {
            noAssociation: {
              content: "Parece que o email selecionado não está registrado no Gravatar. " + "Cadastre-se para uma conta do Gravatar visitando o site oficial do Gravatar ou " + "use um dos seguintes.",
        ...
        hostedAvatar: {
          ...
          input: {
            errors: {
              http: {
                content: "O URL selecionado aponta para uma imagem não segura veiculada por HTTP. " + "Prossiga com cuidado.",
            ...
            warnings: {
              dataURL: {
                content: "Usar URLs de dados com grande contagem de caracteres pode resultar em " + "problemas de banco de dados. Prossiga com cuidado.",
    ...
    sessionTimeoutModal: {
      description: "Você será desconectado da sessão atual devido à inatividade." + "Selecione Permanecer conectado se desejar continuar a sessão.",
