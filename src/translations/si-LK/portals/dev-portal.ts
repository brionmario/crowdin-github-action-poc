...
export const devPortal: DevPortalNS = {
  ...
  components: {
    URLInput: {
      withLabel: {
        negative: {
          content: "The origin of the redirect URL {{url}} is not allowed to make CORS requests to WSO2 " + "Identity Server APIs.",
          detailedContent: {
            0: "By default WSO2 Identity Server APIs blocks CORS requests. But this can also prevent " + "legitimate requests from known",
            1: "Therefore enabling CORS for this origin will allow you to access Identity Server APIs " + "from the applications registered in the <1>{{ tenantName }}</1> tenant domain."
          },
          header: "CORS Not Allowed",
          leftAction: "Allow"
        },
        positive: {
          content: "The origin of the redirect URL {{url}} is allowed to make CORS requests to WSO2 " + "Identity Server APIs.",
          detailedContent: {
            0: "By default WSO2 Identity Server APIs blocks CORS requests. But this can also prevent " + "legitimate requests from known",
            1: "Therefore enabling CORS for this origin will allow you to access Identity Server APIs " + "from the applications registered in the <1>{{ tenantName }}</1> tenant domain."
          },
    ...
    applications: {
      ...
      confirmations: {
        deleteApplication: {
          ...
          content: "If you delete this application, you will not be able to get it back. All the " + "applications depending on this also might stop working. Please proceed with caution.",
          header: "Are you sure?",
          message: "This action is irreversible and will permanently delete the application."
        },
        deleteOutboundProvisioningIDP: {
          assertionHint: "Please type <1>{{ name }}</1> to confirm.",
          content: "If you delete this outbound provisioning IDP, you will not be able to get it back. " + "Please proceed with caution.",
          header: "Are you sure?",
          message: "This action is irreversible and will remove the IDP."
        },
        deleteProtocol: {
          assertionHint: "Please type <1>{{ name }}</1> to confirm.",
          content: "If you delete this protocol, you will not be able to get it back. All the " + "applications depending on this also might stop working. Please proceed with caution.",
          header: "Are you sure?",
          message: "This action is irreversible and will permanently delete the protocol."
        },
        regenerateSecret: {
          assertionHint: "Please type <1>{{ id }}</1> to confirm.",
          content: "If you regenerate this application, All the applications depending on this also might " + "stop working. Please proceed with caution.",
          header: "Are you sure?",
          message: "This action is irreversible and permanently change the client secret."
        },
        revokeApplication: {
          assertionHint: "Please type <1>{{ id }}</1> to confirm.",
          content: "If you Revoke this application, All the applications depending on this also might stop " + "working. Please proceed with caution.",
          header: "Are you sure?",
        ...
        sections: {
          ...
          provisioning: {
            inbound: {
              ...
              subHeading: "Provision users or groups to a WSO2 Identity Server’s userstore via this " + "application."
            },
            outbound: {
              actions: {
              ...
              subHeading: "Configure an identity provider to outbound provision the users of this " + "application."
            },
              ...
              authenticationFlow: {
                ...
                sections: {
                  scriptBased: {
                    ...
                    hint: "Define the authentication flow via an adaptive script. You can select " + "one of the templates fom the panel to get started."
                  },
                  stepBased: {
                    actions: {
                    ...
                    hint: "Create authentication steps by dragging the local/federated " + "authenticators on to the relevant steps."
                  }
                }
              },
      ...
      forms: {
        advancedAttributeSettings: {
          sections: {
            role: {
              fields: {
                role: {
                  hint: "This option will append the user store domain that the user resides to " + "role",
            ...
            subject: {
              fields: {
                ...
                subjectIncludeUserDomain: {
                  hint: "This option will append the user store domain that the user resides in " + "the local subject identifier",
                ...
                subjectUseMappedLocalSubject: {
                  hint: "This option will use the local subject identifier when asserting the " + "identity",
        ...
        advancedConfig: {
          fields: {
            enableAuthorization: {
              hint: "Decides whether authorization policies needs to be engaged during authentication " + "flows.",
            ...
            returnAuthenticatedIdpList: {
              hint: " The list of authenticated Identity Providers will be returned in the " + "authentication response.",
        ...
        generalDetails: {
          fields: {
            accessUrl: {
              ...
              validations: {
                empty: "A valid access URL needs to be defined for an application to be marked as " + "discoverable",
                invalid: "This is not a valid URL"
              }
            },
            description: {
        ...
        inboundOIDC: {
          fields: {
            allowedOrigins: {
              hint: "Allowed Origins are URLs that will be allowed to make requests from cross " + "origins to WSO2 Identity Server APIs",
            ...
            callBackUrls: {
              hint: "After the authentication, we will only redirect to the above redirect URLs " + "and you can specify multiple URLs",
              label: "Redirect URLs",
          ...
          sections: {
            accessToken: {
              fields: {
                ...
                revokeToken: {
                  hint: "Allow to revoke tokens of this application when a bound IDP session " + "gets terminated",
              ...
              hint: " Configure the access token issuer, user access token expiry time, application " + "access token expiry time etc."
            },
            idToken: {
              fields: {
                algorithm: {
            ...
            pkce: {
              ...
              heading: "PKCE",
              hint: "PKCE (RFC 7636) is an extension to the Authorization Code flow to prevent " + "certain attacks and to be able to securely perform the OAuth exchange from public " + "clients."
            },
            refreshToken: {
              fields: {
                expiry: {
        ...
        inboundSAML: {
          fields: {
            assertionURLs: {
              hint: "This specifies the assertion Consumer URLs that the browser " + "should be redirected to after the authentication is successful. " + "This is the Assertion Consumer Service (ACS) URL of the Application.",
            ...
            defaultAssertionURL: {
              hint: "As there can be multiple assertion consumer URLs, you must define a " + "Default Assertion Consumer URL in case you are unable to retrieve " + "it from the authentication request.",
            ...
            idpEntityIdAlias: {
              hint: "This value can override identity provider entity Id that is specified under " + "SAML SSO inbound authentication configuration of the resident identity provider. " + "The Identity Provider Entity Id is used as the issuer of " + "the SAML response that is generated.",
            ...
            issuer: {
              hint: "This specifies the issuer. This is the &quot;saml:Issuer&quot; element that " + "contains the unique identifier of the Application. This is also the issuer value" + "specified in the SAML Authentication Request issued by the Application.",
              label: "Issuer",
            ...
            qualifier: {
              hint: "This value is needed only if you have to configure multiple SAML SSO " + "inbound authentication configurations for the same Issuer value. Qualifier " + "that is defined here will be appended to the issuer internally to " + "identify a application uniquely at runtime.",
          ...
          sections: {
            assertion: {
              fields: {
                ...
                nameIdFormat: {
                  hint: "This defines the name identifier formats that are supported by " + "the identity provider. Name identifiers are used to provide information\n" + "regarding a user.",
            ...
            attributeProfile: {
              fields: {
                enable: {
                  hint: "The Identity Server provides support for a basic attribute profile where " + "the identity provider can include the user’s attributes in the SAML " + "Assertions as part of the attribute statement.",
                  label: "Enable"
                },
                includeAttributesInResponse: {
                  hint: "Once you select the checkbox to Include Attributes in the Response " + "Always, the identity provider always includes the attribute values related " + "to the selected claims in the SAML attribute statement.",
                  label: "Always include attributes in response"
                },
                serviceIndex: {
                  hint: "This is an optional field if not provided a value will be generated " + "automatically.",
            ...
            idpInitiatedSLO: {
              fields: {
                enable: {
                  hint: "When this is enabled, the service provider is not required to send " + "the SAML request.",
                  label: "Enable",
                  validations: {
                    empty: "This is a required field."
                  }
            ...
            requestValidation: {
              fields: {
                signatureValidation: {
                  hint: "This specifies whether the identity provider must validate the signature " + "of the SAML2 authentication request and the SAML2 logout request " + "that are sent by the application.",
                ...
                signatureValidationCertAlias: {
                  hint: "If application certificate is provided then it will be used and above " + "selected certificate will be ignored.",
            ...
            ssoProfile: {
              fields: {
                artifactBinding: {
                  hint: "Artifact resolve request signature will be validated against " + "the Application certificate.",
        ...
        provisioningConfig: {
          fields: {
            proxyMode: {
              hint: "Users/Groups are not provisioned to the user store. They are only outbound " + "provisioned.",
              label: "Proxy mode"
            },
            userstoreDomain: {
      ...
      helpPanel: {
        tabs: {
          configs: {
            content: {
              subTitle: "Update the pre defined configurations through the template or add new " + "configurations depending on the protocol (OIDC, SAML, WS-Trust, etc.) configured " + "for the application.",
            ...
            content: {
              sample: {
                configurations: {
                  ...
                  subTitle: "In order to integrate the application created in the server with " + "the sample application, you need to initialise the client with following " + "configurations.",
                  title: "Initialize the client"
                },
                downloadSample: {
                  btn: "Download the sample",
                  subTitle: "This sample application will show case the usage of the of WSO2 " + "Identity Server SDK and how you can integrate any application with Identity " + "Server.",
                  title: "Try out the sample"
                },
                goBack: "Go back",
                subTitle: "Quickly start prototyping by downloading our preconfigured sample " + "application.",
                title: "Sample Applications"
              },
              technology: {
                subTitle: "Sample and required SDKs along with useful information will be provided " + "once you select a technology",
          ...
          sdks: {
            content: {
              sdk: {
                goBack: "Go back",
                subTitle: "Following software development kits can be used to jump start your " + "application development.",
          ...
          start: {
            content: {
              endpoints: {
                subTitle: "If you implement your application without using a WSO2 SDK, the " + "following server endpoints will be useful for you to implement authentication " + "for the app.",
              ...
              trySample: {
                btn: "Explore samples",
                subTitle: "You can try out the samples which will demonstrate the authentication " + "flow. Click the button below to download and deploy the sample application.",
              ...
              useSDK: {
                ...
                subTitle: "Install and use our SDKs to integrate authentication to your application " + "with minimum number of code lines.",
      ...
      notifications: {
        ...
        emptyAuthenticationStep: {
          genericError: {
            description: "There is an empty authentication step. Please remove it or add authenticators " + "to proceed.",
      ...
      placeholders: {
        ...
        emptyOutboundProvisioningIDPs: {
          action: "New IDP",
          subtitles: "This Application has no outbound provisioning IDPs configured." + " Add an IDP to view it here.",
    ...
    idp: {
      ...
      confirmations: {
        deleteAuthenticator: {
          assertionHint: "Please type <1>{{ name }}</1> to confirm.",
          content: "If you delete this authenticator, you will not be able to get it back. All the " + "applications depending on this also might stop working. Please proceed with caution.",
          header: "Are you sure?",
          message: "This action is irreversible and will permanently delete the authenticator."
        },
        deleteConnector: {
          assertionHint: "Please type <1>{{ name }}</1> to confirm.",
          content: "If you delete this connector, you will not be able to get it back. Please " + "proceed with caution.",
          header: "Are you sure?",
          message: "This action is irreversible and will permanently delete the connector."
        },
        deleteIDP: {
          assertionHint: "Please type <1>{{ name }}</1> to confirm.",
          content: "If you delete this identity provider, you will not be able to get it back. All the " + "applications depending on this also might stop working. Please proceed with caution.",
          header: "Are you sure?",
      ...
      dangerZoneGroup: {
        ...
        disableIDP: {
          ...
          subheader: "Once you disable an identity provider, it can no longer be used until " + "you enable it again. Please be certain."
        },
        header: "Danger Zone"
      },
      forms: {
        advancedConfigs: {
          alias: {
            hint: "If the resident identity provider is known by an alias at the federated identity " + "provider, specify it here.",
            label: "Alias"
          },
          certificateType: {
            certificateJWKS: {
            ...
            hint: "If the type is JWKS, the value should be a JWKS URL. If the type is PEM, the" + " value should be the certificate in PEM format.",
        ...
        jitProvisioning: {
          enableJITProvisioning: {
            hint: "Specifies if users federated from this identity provider " + "needs to be provisioned locally.",
        ...
        tabs: {
          samples: {
            content: {
              docs: {
                goBack: "Go back",
                hint: "Click on the following  Identity Provider types to check out the " + "corresponding documentation.",
      ...
      notifications: {
        ...
        changeCertType: {
          jwks: {
            description: "Please note that if you have added a certificate it'll be overridden by the " + "the JWKS endpoint.",
            message: "Warning!"
          },
          pem: {
            description: "Please note that if you have added a JWKS endpoint it'll be overridden by the " + "certificate.",
            message: "Warning!"
          }
        },
    ...
    oidcScopes: {
      ...
      confirmationModals: {
        deleteClaim: {
          assertionHint: "Please type <1>{{ name }}</1> to confirm.",
          content: "If you delete this claim, you will not be able to get it back." + "Please proceed with caution.",
          header: "Are you sure?",
          message: "This action is irreversible and will permanently delete the OIDC claim."
        },
        deleteScope: {
          assertionHint: "Please type <1>{{ name }}</1> to confirm.",
          content: "If you delete this scope, you will not be able to get it back." + "Please proceed with caution.",
          header: "Are you sure?",
      ...
      quickLinks: {
        cards: {
          ...
          idps: {
            ...
            subHeading: "Create and manage identity providers based on templates and configure " + "authentication."
          },
          remoteFetch: {
    ...
    remoteConfig: {
      ...
      list: {
        ...
        confirmations: {
          deleteConfig: {
            assertionHint: "Please type <1>{{ name }}</1> to confirm.",
            content: "If you delete this configuration, you will not be able to get it back." + "Please proceed with caution.",
            header: "Are you sure?",
  ...
  pages: {
    ...
    overview: {
      subTitle: "Configure and  manage applications, identity providers, users and roles, attribute dialects, " + "etc.",
