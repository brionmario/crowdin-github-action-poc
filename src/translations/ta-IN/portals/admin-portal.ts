  ...
  components: {
    ...
    certificates: {
      keystore: {
        ...
        confirmation: {
          ...
          tenantContent: "This will delete the tenant certificate permanently." + "Once deleted, unless you import a new tenant certificate," + "you won't be able to access the portal applications." + "To continue deleting, enter the alias of the certificate and click delete."
        },
        errorCertificate: "An error occurred while decoding the certificate." + " Please ensure the certificate is valid.",
        ...
        placeholders: {
          emptyList: {
            ...
            subtitle: "There are currently no certificates available." + "You can import a new certificate by clicking on" + "the button below.",
    ...
    claims: {
      dialects: {
        ...
        confirmations: {
          action: "Confirm",
          content: "If you delete this external dialect, all the associated external attributes will " + "also be deleted.Please proceed with caution.",
          header: "Are you sure?",
        ...
        notifications: {
          addDialect: {
            ...
            genericError: {
              description: "The external dialect has been added but not all external " + "attributes were added successfully",
      ...
      external: {
        ...
        placeholders: {
          empty: {
            subtitle: "Currently, there are no external attributes available for " + "this dialect.",
      ...
      list: {
        ...
        confirmation: {
          ...
          dialect: {
            message: "If you delete this external dialect, all the" + " associated external attributes will also be deleted.",
          ...
          local: {
            message: "If you delete this local attribute, the user data belonging " + "to this attribute will also be deleted.",
        ...
        placeholders: {
          emptyList: {
            ...
            subtitle: "There are currently no results available." + "You can add a new item easily by following the" + "steps in the creation wizard.",
            title: {
        ...
        warning: "This attribute has not been mapped to an attribute" + " in the following userstores:"
      },
      local: {
        ...
        confirmation: {
          content: "If you delete this local attribute, the user data belonging to this attribute " + "will also be deleted. Please proceed with caution.",
          header: "Are you sure?",
        ...
        forms: {
          ...
          attributeHint: "A unique ID for the attribute." + " The ID will be appended to the dialect URI to create a attribute URI",
          attributeID: {
            label: "Attribute ID",
          ...
          displayOrderHint: "This determines the position at which this attribute is " + "displayed in the user profile and the user registration page",
          name: {
            label: "Name",
            placeholder: "Enter a name for the attribute",
            requiredErrorMessage: "Name is required"
          },
          nameHint: "Name of the attribute that will be shown on the user profile " + "and user registration page",
          readOnly: {
        ...
        notifications: {
          ...
          updateClaim: {
            ...
            success: {
              description: "This local attribute has been " + "updated successfully!",
    ...
    emailTemplateTypes: {
      ...
      confirmations: {
        deleteTemplateType: {
          ...
          content: "If you delete this email template type, all associated work flows will no longer " + "have a valid email template to work with and this will delete all the locale templates " + "associated with this template type. Please proceed cautiously.",
          header: "Are you sure?",
          message: "This action is irreversible and will permanently delete the selected email template " + "type."
        }
      },
      forms: {
        addTemplateType: {
    ...
    emailTemplates: {
      ...
      confirmations: {
        deleteTemplate: {
          assertionHint: "Please type <1>{{ id }}</1> to confirm.",
          content: "If you delete this email template, all associated work flows will no longer " + "have a valid email template to work with. Please proceed cautiously.",
          header: "Are you sure?",
      ...
      edit: {
        basics: {
          ...
          confirmation: {
            ...
            content: "If you delete this {{type}}, the permissions attached to it will be deleted and " + "the users attached to it will no longer be able to perform intended actions which were " + "previously allowed. Please proceed with caution",
            header: "Are you sure?",
    ...
    user: {
      deleteUser: {
        confirmationModal: {
          ...
          content: "If you delete this user, the user will not be able to login to the developer portal or " + "any other application the user was subscribed before. Please proceed with caution.",
          header: "Are you sure?",
      ...
      modals: {
        addUserWarnModal: {
          heading: "Warning",
          message: "Please note that this created user will not be assigned with a role. If you wish to " + "assign roles to this user please click on the button below."
        },
        addUserWizard: {
          buttons: {
            next: "Next",
      ...
      updateUser: {
        groups: {
          ...
          editGroups: {
            ...
            subHeading: "Add or remove the groups user is assigned with and note that this will affect " + "performing certain tasks."
          },
          notifications: {
            addUserGroups: {
              error: {
        ...
        roles: {
          ...
          editRoles: {
            ...
            subHeading: "Add or remove the roles user is assigned with and note that this will affect " + "performing certain tasks."
          },
          notifications: {
            addUserRoles: {
              error: {
    ...
    userstores: {
      ...
      confirmation: {
        confirm: "Confirm",
        content: "If you delete this userstore, the user data in this userstore will also be deleted. " + "Please proceed with caution.",
        header: "Are you sure?",
        hint: "Please type <1>{{name}}</1> to confirm.",
        message: "This action is irreversible and will permanently delete the" + " selected userstore and the data in it."
      },
      dangerZone: {
        actionTitle: "Delete Userstore",
        header: "Delete Userstore",
        subheader: "Once you delete a userstore, there is no going back. " + "Please be certain."
      },
      forms: {
        connection: {
          connectionErrorMessage: "Please ensure the provided connection " + "URL, name, password and driver name are correct",
      ...
      notifications: {
        ...
        delay: {
          description: "It may take a while for the userstore list to be updated. " + "Refresh in a few seconds to get the updated userstore list.",
      ...
      placeholders: {
        emptyList: {
          ...
          subtitles: "There are currently no userstores available." + "You can add a new userstore easily by following the " + "steps in the userstore creation wizard.",
